...
Modules.settings = function(container) {
  ...
  container.innerHTML = `
    ...
    <div class="card card-pad" style="margin-top:20px;">
      <div class="sec-title" style="margin-bottom:10px;">About DOT Ecosystem</div>
      <p style="font-size:12.5px;color:var(--text-dim);line-height:1.7;margin:0;">
        DOT Ecosystem is an independent software ecosystem founded and designed by Ananthu Shaji, built around the philosophy <b>"Enter Once. Trust Everywhere."</b> Every application in the ecosystem is designed for professional user experience, enterprise-level reliability, and connected workflows across independent apps.
      </p>
      ...
      <div id="about-full" class="hidden" style="margin-top:16px;padding-top:16px;border-top:1px solid var(--line);font-size:12.5px;color:var(--text-dim);line-height:1.8;">
        <p>DOT Ecosystem is an independent software ecosystem founded and designed by Ananthu Shaji with a vision to build intelligent, connected, and enterprise-grade software solutions for businesses, professionals, educators, and creators.</p>
        <p>Every application within the DOT Ecosystem is developed around a single philosophy:</p>
        <p style="font-family:var(--font-display);font-size:14px;color:var(--ink);font-weight:600;text-align:center;margin:16px 0;">"Enter Once. Trust Everywhere."</p>
        <p>This principle ensures seamless workflows, consistent data, intelligent automation, and a unified user experience across every DOT application.</p>

        <div class="sec-title" style="margin:20px 0 10px;">Founder</div>
        <p style="margin-bottom:2px;"><b style="color:var(--ink);">Ananthu Shaji</b></p>
        <p style="margin-bottom:14px;">Founder &amp; Software Architect, DOT Ecosystem</p>
        <p>Driven by a passion for solving real-world problems through technology, Ananthu Shaji envisioned the DOT Ecosystem as a unified platform where independent applications work together as one intelligent digital environment.</p>

        <div class="sec-title" style="margin:20px 0 10px;">Our Vision</div>
        <p>To build one of the world's most trusted software ecosystems by delivering secure, intelligent, scalable, and beautifully designed applications that simplify work and empower people.</p>

        <div class="sec-title" style="margin:20px 0 10px;">Designed with Purpose</div>
        <p>Every DOT application is designed with:</p>
        ...
        <p style="text-align:center;font-size:11.5px;color:var(--text-faint);">Designed &amp; Developed by Ananthu Shaji<br>© DOT Ecosystem. All Rights Reserved.</p>
      </div>
    </div>
  `;
